...
Original file is located at
    https://colab.research.google.com/drive/1CCDkS0AtEybpO0kd2WeyzLgEcLVhyO2r

Notebook voltado ao curso grátis do canal: Ignorância 0.
(Curso voltado para o ambiente de Ciência de dados)
"""

class Carro:
  def __init__(self, modelo = None, ano= None, marca = None, cor = None):
    self.modelo = modelo
    self.ano = ano
    self.marca = marca
    self.cor = cor
  ...
  def descricao_carro(self):
    return "O carro tem a cor: " + self.get_cor() + " e ano: " + self.get_ano()

carro = Carro()
carro.set_cor("vermelha")
carro.set_ano("1990")
print(carro.descricao_carro())

"""Questão 12 (Jogo dos 15)"""
